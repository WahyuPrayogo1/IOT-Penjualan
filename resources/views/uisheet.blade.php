...
<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative"
        style="background-image: url('{{ asset('images/bg-depan.jpg') }}');
        ...
        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
            <div class="container">
               <h1 class="display-3 fw-bold poppins-extrabold">POS IOT SYSTEM</h1>
<p class="poppins-medium">
    Aplikasi Point of Sale terintegrasi dengan IoT & Mobile untuk manajemen penjualan modern.
</p>

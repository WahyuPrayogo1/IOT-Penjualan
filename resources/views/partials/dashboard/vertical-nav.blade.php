<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    <li class="nav-item static-item">
     ...
     <!-- Admin -->
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('devices.index')) }}"
            ...
            <span class="item-name">Barcode</span>
        </a>
    </li>
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#">
            <span class="default-icon">Extension</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    ...
    <!-- Admin -->
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('configs.edit')) }}"
            href="{{ route('configs.edit') }}">
            <i class="icon">
               <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <!-- Sales Menu -->
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('rules.index')) }}" href="{{ route('rules.index') }}">
            <i class="icon">
               <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
